# Notice, Droits d'auteur des photographies

Toutes les photographies du dossier `assets/photos/` (et toutes les
photographies utilisées en image de partage `og:image`) sont l'œuvre
exclusive de :
...
L'indexation des images par les moteurs de recherche est autorisée
(`max-image-preview:large`) afin d'améliorer la visibilité du congrès.
Cela ne vaut **pas** autorisation de réutilisation : l'apparition dans
les résultats d'un moteur de recherche n'éteint en rien les droits
d'auteur.
